...
@push('style')
    ...
    <link rel="stylesheet" type="text/css"
        href="{{asset('plugins/switchery/switchery.min.css')}}"/>
    <!-- bootstrap-tagsinput css -->
    <link rel="stylesheet" type="text/css"
        href="{{asset('plugins/bootstrap-tagsinput/bootstrap-tagsinput.css')}}"/>
    <!-- bootstrap-touchspin css -->
    <link rel="stylesheet" type="text/css"
        href="{{asset('plugins/bootstrap-touchspin/jquery.bootstrap-touchspin.css')}}"/>
@endpush
...
@push('script')
    ...
    <script src="{{asset('scripts/pages/advanced-components.js')}}"></script>
@endpush
