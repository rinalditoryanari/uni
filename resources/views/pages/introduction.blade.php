                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item active" href="{{asset('introduction')}}">
                                    Introduction</a>
                                <a class="dropdown-item" href="{{asset('getting-started')}}">
                                    Getting Started</a>
                                <a class="dropdown-item" href="{{asset('color-settings')}}">
                                    Color Settings</a>
                                <a class="dropdown-item" href="{{asset('third-party-plugins')}}">
            ...
            >
                <ul>
                    <li class="d-flex pb-20">
                        <i class="dw dw-edit-file font-20 mr-2"></i>
                        We have used our name and brand as credit in CSS / Js we have created, you need to change /
                        remove that if you want while using in your personal or client projects.
                    </li>
                    <li class="d-flex pb-20">
                        <i class="dw dw-edit-file font-20 mr-2"></i>
                        You will find name and brand of each third-party tools we have used, as credit in
                        their respective css / js, you can remove or change as per your need.
                    </li>
                    <li class="d-flex pb-20">
                        <i class="dw dw-edit-file font-20 mr-2"></i>
                        We have used third-party tools / plugins in our templates, you will find links from left
                        navigation (menu) as Third Party Tools and you can find their documentation from their
                        respective websites link we have given.
                    </li>
                    <li class="d-flex pb-20">
                        <i class="dw dw-edit-file font-20 mr-2"></i>
