                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="{{asset('introduction')}}">
                                    Introduction</a>
                                <a class="dropdown-item" href="{{asset('getting-started')}}">
                                    Getting Started</a>
                                <a class="dropdown-item active" href="{{asset('color-settings')}}">
                                    Color Settings</a>
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <p>
                            <img
                                src="{{asset('images/layout/sidebar-dark.png')}}"
                                class="box-shadow"
                                alt=""
                            />
                        </p>
                    ...
                    <div class="col-md-7">
                        ...
                        <p>
                            <img
                                src="{{asset('images/layout/sidebar-white.png')}}"
                                class="box-shadow"
                                alt=""
                            />
                        </p>
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="row">
                    <div class="col-md-12 mb-20">
                        ...
                        <p>
                            <img
                                src="{{asset('images/layout/header-white.png')}}"
                                class="box-shadow"
                                alt=""
                            />
                        </p>
                    ...
                    <div class="col-md-12">
                        ...
                        <p>
                            <img
                                src="{{asset('images/layout/header-dark.png')}}"
                                class="box-shadow"
                                alt=""
                            />
                        </p>
