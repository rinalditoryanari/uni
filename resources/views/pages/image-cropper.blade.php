...
@push('style')
    <link rel="stylesheet" type="text/css" href="{{asset('plugins/cropperjs/dist/cropper.css')}}"/>
@endpush
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-9">
                        ...
                        <div class="img-container">
                            <img src="{{asset('images/img3.jpg')}}" id="image" alt="Picture"/>
                        </div>
                    </div>
...
@push('script')
    ...
    <script src="{{asset('plugins/cropperjs/dist/cropper-init.js')}}"></script>
@endpush
