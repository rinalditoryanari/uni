                        ...
                        <div class="collapse collapse-box" id="carousel1">
                            <div class="code-box">
                                ...
                                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img class="d-block w-100" src="{{asset('images/img2.jpg')}}"
                                                alt="First slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="{{asset('images/img3.jpg')}}"
                                                alt="Second slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="{{asset('images/img4.jpg')}}"
                                                alt="Third slide">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="code-box">
                                ...
                                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="{{asset('images/img5.jpg')}}"
                                                alt="Third slide">
                                        </div>
                                    </div>
                        ...
                        <div class="collapse collapse-box" id="carousel4">
                            <div class="code-box">
                                ...
                                <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img class="d-block w-100" src="{{asset('images/img1.jpg')}}"
                                                alt="First slide"/>
                                            <div class="carousel-caption d-none d-md-block">
                                                <h5 class="color-white">First slide label</h5>
