...
@push('style')
    <link rel="stylesheet" type="text/css" href="{{asset('plugins/jquery-asColorPicker/dist/css/asColorPicker.css')}}"/>
@endpush
...
@push('script')
    ...
    <script src="{{asset('plugins/jquery-asColorPicker/jquery-asColorPicker.js')}}"></script>
    <script src="{{{asset('scripts/pages/colorpicker.js')}}}"></script>
@endpush
