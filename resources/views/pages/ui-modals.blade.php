                ...
                <div class="col-md-4 col-sm-12 mb-30">
                    <div class="pd-20 card-box height-100-p">
                        ...
                        <a
                            ...
                            type="button"
                        >
                            <img src="{{asset('images/modal-img1.jpg')}}" alt="modal"/>
                        </a>
                        <div
                ...
                <div class="col-md-4 col-sm-12 mb-30">
                    <div class="pd-20 card-box height-100-p">
                        ...
                        <a
                            ...
                            type="button"
                        >
                            <img src="{{asset('images/modal-img2.jpg')}}" alt="modal"/>
                        </a>
                        <div
                            class="modal fade"
                            id="Medium-modal"
                ...
                <div class="col-md-4 col-sm-12 mb-30">
                    <div class="pd-20 card-box height-100-p">
                        ...
                        <a
                            ...
                            type="button"
                        >
                            <img src="{{asset('images/modal-img3.jpg')}}" alt="modal"/>
                        </a>
                        <div
                            class="modal fade"
                            id="small-modal"
